...
|------------|-----------|
|`custom_geckodriver_executable`|Allow specifying a custom `geckodriver` location using the [`appium:geckodriverExecutable` capability](./capabilities.md#geckodriverexecutable). Available since driver version 2.2.0.|
